...
export const languages = {
	en:
	{
		home: {
			...
			intro2: " with 2+ years of experience focused on making Web Applications that load fast, look good and are easy to use.",
			...
			a3: "\nI've worked with distributed teams across Africa and Europe, check out my experience & skills.",
			details: "I design & code Web Apps"
		},
		experience: {
			intro: " I started my career as a DevsOp developer, working with version control system and maintaining uptime running of server Instances. I've been part of small and large (distributed) teams, I understood how version control, and effective team communication are in terms of having a sane workflow.\n\n Today I'm working as a front-end developer and reaching a personal milestone, which is feeling confident in both sides of the spectrum to develop Web Apps from back to front.",
			quote: "Every great developer you know got there by solving problems they were unqualified to solve until they actually did it.",
			title: "EXPERIENCE",
			backendDesc: " I've worked extensively in large-scale applications using JavaScript stack (Mongodb, Express, EJS, Node).\n\n My short-term goal is to keep learning how to leverage cloud services platforms to enhance my development process. Serverless and micro-services? I'm in!",
			frontendDesc: " Front-end is where I've been focused for the last couple of years. Today I'm working in this area using HTML5, CSS3, Javascript, on a daily basis.\n\n I'm also working with ReactJS, which has become one of my favorite tools in web development",
		...
		contact: {
			title: 'CONTACT',
			content: " Do you have a project you'd want me to jump in or want to get in touch? Shoot me a message filling the form below and I'll get back to you as soon as I can. Or email me directly at oluwatimilehinainaj@gmail.com",
			name: "Name",
			subject: "Subject",
			message: "Message",
			required: "required",
		...
		projects: {
			...
			caf: {
				...
				home: "Home Page",
				about: "Chicas Al Frente (Girls In Front) is a non-profit feminist collective from Costa Rica",
				...
				// testimonial: "Georgina programmed the website for the feminist collective Chicas al Frente at the end of 2018. We reviewed her resume and after interviewing her we decided she was a good fit due to her demonstration of knowledge in the design and development of websites. During the elaboration of the final product Georgina was very willing, respectful and proactive, providing technical recommendations to achieve a better result. \n\nThe final product turned out as expected, we were very happy and grateful for the work done and also for Georgina's involvement, beyond simply doing her job, she showed commitment and identification with the project.",
				// devto: "How I leveraged JAMstack to cut down costs for a nonprofit."
			},
		},
		misc: {
			here: "here",
	...
	es: {
		home: {
			...
			intro2: " con 2+ años de experiencia especializada en crear Aplicaciones Web que carguen rápido, se vean bien y sean fáciles de usar.",
		...
		experience: {
			intro: " Empecé mi carrera como desarrolladora DevsOp, trabajando en versionamiento control and Server Instances uptime. He sido parte de equipos pequeños y grandes (distribuidos), ahí entendí lo versionamiento y la comunicación efectiva dentro del equipo en pos de mantener un flujo de trabajo sano.\n" +
				"\n" +
			...
			title: "EXPERIENCIA",
			backendDesc: " He trabajado extensamente en aplicaciones a gran escala usando frameworks de JavaScript (Mongodb, Express, EJS, Nodejs). También trabajé con NodeJS integrando almacenamiento en la nube de Amazon Web Services.\n\n Mi meta a corto plazo es seguir aprendiendo sobre servicios en la nube (como AWS) para mejorar mi proceso de desarrollo.",
			frontendDesc: " En la parte front-end es donde he estado enfocada durante el último par de años. Actualmente estoy trabajando en esta área usando HTML5, CSS3 y Javascript diariamente.\n\n También estoy trabajando con ReactJS, la cual se ha convertido en una de mis herramientas preferidas en el desarrollo web.",
		...
		contact: {
			title: 'CONTACTO',
			content: "¿Tiene algún proyecto en el que le gustaría que participe o quiere ponerse en contacto? Envíeme un mensaje llenando el formuario y responderé lo más pronto posible. O envíame un correo directamente a oluwatimilehinainaj@gmail.com",
			name: "Nombre",
			subject: "Asunto",
			message: "Mensaje",
			required: "requerido",
		...
		projects: {
			...
			caf: {
				...
				about: "Chicas Al Frente es un colectivo feminista sin fines de lucro de Costa Rica.",
				...
				// testimonial: "Georgina programó el sitio web para la colectivia feminista Chicas al Frente a finales del año 2018.  Revisamos su currículo y luego de la entrevista nos decidimos por ella debido a su demostración de conocimiento en el diseño y desarrollo de sitios web.  Durante la elaboración del producto final Georgina se mostró muy anuente, respetuosa y proactiva, brindando recomendaciones técnicas para lograr obtener un mejor resultado.  \n\nEl producto final resultó ser lo esperado, quedamos muy contentas y agradecidas por el trabajo realizado y además por el involucramiento que Georgina tuvo con el proyecto, más allá de simplemente realizar su trabajo, mostró compromiso e identificación con el proyecto.",
				// devto: "How I leveraged JAMstack to cut down costs for a nonprofit."
			},		
